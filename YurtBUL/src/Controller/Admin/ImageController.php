...
class ImageController extends AbstractController
{
    ...
    /**
     * @Route("/new/{yid}", name="admin_image_new", methods="GET|POST")
     */
    public function new(Request $request,$yid,ImageRepository $imageRepository): Response
    {

        $imagelist = $imageRepository->findBy(['yurtid' => $yid]);
        $image = new Image();
        ...
        if ($request->files->get('imname')) {
            ...
            return $this->redirectToRoute('admin_image_new',array('yid' => $yid));
        }
    ...
    /**
     * @Route("/{id}/{yid}", name="admin_image_del", methods="GET")
     */
    public function del(Request $request, Image $image, $yid): Response
    {
